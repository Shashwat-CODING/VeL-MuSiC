...
import 'package:vel_music/ytmusic/ytmusic.dart';
...
class SectionItem extends StatefulWidget {
  const SectionItem({required this.section, this.isMore = false, this.isFirstSection = false, super.key});
  final Map section;
  final bool isMore;
...
class _SectionItemState extends State<SectionItem> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.section['contents'].isEmpty
        ...
        : Column(
            children: [
              if (widget.section['title'] != null && !widget.isFirstSection)
                AdaptiveListTile(
                  contentPadding:
