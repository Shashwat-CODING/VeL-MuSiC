                  ...
                  children: [
                    ...
                    AdaptiveListTile(
                     ...
                     AdaptiveListTile(
                      ...
                      onTap: () => launchUrl(
                          Uri.parse('https://Vel_MuSicmusic.vercel.app'),
                          mode: LaunchMode.externalApplication),
                    ),
                    AdaptiveListTile(
                      margin: const EdgeInsets.symmetric(vertical: 4),
                    ...
                    AdaptiveListTile(
                      ...
                      onTap: () => launchUrl(
                          Uri.parse(
                              'https://github.com/jhelumcorp/Vel_MuSic/contributors'),
                          mode: LaunchMode.externalApplication),
                    ),
                    AdaptiveListTile(
                      margin: const EdgeInsets.symmetric(vertical: 4),
                      ...
                      trailing: Icon(AdaptiveIcons.chevron_right),
                      onTap: () => launchUrl(
                          Uri.parse('https://github.com/jhelumcorp/Vel_MuSic'),
                          mode: LaunchMode.externalApplication),
                    ),
                    AdaptiveListTile(
                      margin: const EdgeInsets.symmetric(vertical: 4),
                      ...
                      onTap: () => launchUrl(
                          Uri.parse(
                              'https://github.com/jhelumcorp/Vel_MuSic/issues/new?assignees=&labels=bug&projects=&template=bug_report.yaml'),
                          mode: LaunchMode.externalApplication),
                    ),
                    AdaptiveListTile(
                      margin: const EdgeInsets.symmetric(vertical: 4),
                      ...
                      onTap: () => launchUrl(
                          Uri.parse(
                              'https://github.com/jhelumcorp/Vel_MuSic/issues/new?assignees=sheikhhaziq&labels=enhancement%2CFeature+Request&projects=&template=feature_request.yaml'),
                          mode: LaunchMode.externalApplication),
                    ),
                    Center(
                      child: Padding(
                        padding: const EdgeInsets.all(16),
                        child: Text(S.of(context).Made_In_Uttar_Pradesh),
                      ),
                    ),
                  ],
                ),
