...
class S {
  ...
  /// `Vel_MuSic`
  String get Vel_MuSic {
    return Intl.message('Vel_MuSic', name: 'Vel_MuSic', desc: '', args: []);
  }
  ...
  /// `Search Vel_MuSic`
  String get Search_Vel_MuSic {
    return Intl.message(
      'Search Vel_MuSic',
      name: 'Search_Vel_MuSic',
      desc: '',
      args: [],
    );
  }
  ...
  String get Jhelum_Corp {
    return Intl.message('Veltrix', name: 'Jhelum_Corp', desc: '', args: []);
  }
  ...
  /// `Made in Uttar_Pradesh`
  String get Made_In_Uttar_Pradesh {
    return Intl.message(
      'Made in Uttar_Pradesh',
      name: 'Made_In_Uttar_Pradesh',
      desc: '',
      args: [],
    );
  }
