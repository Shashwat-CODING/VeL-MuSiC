              ...
              return Container(
                ...
                child: FilterChip(
                  label: Text(
                    ...
                    style: TextStyle(
                      color: isSelected ? Colors.white : themeProvider.getSecondaryTextColor(),
                  ...
                  backgroundColor: themeProvider.getShimmerHighlightColor(),
                  selectedColor: Theme.of(context).primaryColor,
                  checkmarkColor: Colors.white,
                  side: BorderSide(
                    color: isSelected ? Theme.of(context).primaryColor : themeProvider.getPlaceholderColor(),
                    width: 1,
                  ),
